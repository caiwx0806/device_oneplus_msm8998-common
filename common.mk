...
PRODUCT_ENFORCE_RRO_EXCLUDED_OVERLAYS += \
    $(LOCAL_PATH)/overlay-evo/packages/apps/Snap \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/rootdir/etc/init.target.displaymodes.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.target.displaymodes.rc \
